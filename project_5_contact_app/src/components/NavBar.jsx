    ...
    <div className="flex flex-col gap-[25px]">
      ...
      <BiSearchAlt2  className={`text-[40px] absolute pl-[12px] ${theme? "text-[#3C3C3C]":"text-[#ffffff]"}`}/>
        <input
          ...
          className={` rounded-[10px] h-[40px] min-w-[270px] border-[1.5px] pl-[50px] py-auto bg-transparent placeholder-[#717171] ${theme? "border-[#3C3C3C] text-[#3C3C3C]":"border-[#ffffff] text-[#ffffff]"}`}
        />
        <div className="flex">
